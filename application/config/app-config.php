...
*
*/
define('APP_BASE_URL', 'https://cargo.gictafrica.com/');
...
*/
define('APP_ENC_KEY', 'c7d276c134e446551268ba6cbede5bef');
 ...
 */
define('APP_DB_USERNAME', 'cargounifreight_tests');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'cargounifreight_tests');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'cargounifreight_tests');
