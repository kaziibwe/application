...
<div class="col-md-12">
   <div class="panel_s mbot10">
      <div class="panel-body _buttons">
         ...
         <a href="<?php echo admin_url('bills/invoice'); ?>" class="btn btn-info pull-left new new-invoice-list">
         Criar nova despesa
         </a>
         <?php } ?>
         <a href="<?php echo admin_url('bills'); ?>" class="btn btn-default pull-left mleft5">
            <?php echo _l('go_back'); ?>
         </a>
      ...
      <div class="col-md-12" id="small-table">
         <div class="panel_s">
            <div class="panel-body">
               ...
               <?php $this->load->view('recurring/table_html'); ?>
            </div>
         </div>
      </div>
