...
<div id="wrapper">
        ...
        <div class="row">
            <div class="col-md-7">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <i class="fa-regular fa-circle-question" data-toggle="tooltip" data-title="<?php echo _l('staff_email_signature_help'); ?>"></i>
            ...
            <div class="col-md-5">
                ...
                <div class="panel_s">
                        ...
                        <?php if (is_email_template_active('two-factor-authentication')) { ?>
                            <div class="radio radio-primary">
                                ...
                                <label for="two_factor_auth_enabled">
                                    <i class="fa-regular fa-circle-question" data-placement="right" data-toggle="tooltip" data-title="<?php echo _l('two_factor_authentication_info'); ?>"></i>
                    ...
                    <?php if ($current_user->whatsapp_auth_enabled == '0'): ?>
                        <div class="panel-footer text-right">
                ...
                <?php echo form_close(); ?>
                <?php if ($this->app_modules->is_active('whatsapp_api')) { ?>
                    <h4 class="tw-font-semibold tw-text-lg tw-text-neutral-700 mtop30">
                        <?php echo _l('two_factor_authentication_via_whatsapp'); ?>
                    </h4>
                    <div class="panel_s">
                        <?php echo form_open('admin/whatsapp_api/updateWhatsappAuthStatus', ['id' => 'two_factor_auth_via_whatsapp_form']); ?>
                        <div class="panel-body">
                            <div class="form-group">
                                <label for="whatsapp_auth_enabled" class="control-label clearfix"><?php echo _l('enable_whatsapp_two_factor_authentication') ?></label>
                                <div class="radio radio-primary radio-inline">
                                    <input type="radio" id="y_opt_1_whatsapp_auth_enabled" name="whatsapp_auth_enabled" value="1" <?php echo ($current_user->whatsapp_auth_enabled == '1') ? 'checked' : '' ?>>
                                    <label for="y_opt_1_whatsapp_auth_enabled"><?php echo _l('yes') ?></label>
                                </div>
                                <div class="radio radio-primary radio-inline">
                                    <input type="radio" id="y_opt_2_whatsapp_auth_enabled" name="whatsapp_auth_enabled" value="0" <?php echo ($current_user->whatsapp_auth_enabled == '0') ? 'checked' : '' ?>>
                                    <label for="y_opt_2_whatsapp_auth_enabled"><?php echo _l('no') ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="panel-footer text-right">
                            <button id="submit_otp" type="submit" class="btn btn-primary">
                                <?php echo _l('submit'); ?>
                            </button>
                        </div>
                        <?php echo form_close(); ?>
                    ...
                    <div class="alert alert-info">
                        <h4 class="tw-font-semibold"><?php echo _l('note') ?>!</h4>
                        <ul>
                            <li>-> <?php echo _l('otp_note_1') ?></li>
                            <li>-> <?php echo _l('otp_note_2') ?></li>
                            <li>-> <?php echo _l('otp_note_3') ?></li>
                        </ul>
                    </div>
                <?php } ?>
            </div>
    ...
    <script>
        $(function() {
            ...
            appValidateForm($('#two_factor_auth_via_whatsapp_form'), {
                whatsapp_auth_enabled: 'required'
            });
            <?php if ($current_user->whatsapp_auth_enabled == '1'): ?>
                $('#submit_2fa').attr('disabled', true);
            <?php endif ?>
        });
    </script>
    </body>
